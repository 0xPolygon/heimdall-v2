...
type SuccinctSpecialTx struct {
	...
	MilestoneProposition *types.MilestoneProposition `protobuf:"bytes,2,opt,name=milestone_proposition,json=milestoneProposition,proto3" json:"milestone_proposition,omitempty"`
}

func (m *SuccinctSpecialTx) Reset()         { *m = SuccinctSpecialTx{} }
func (m *SuccinctSpecialTx) String() string { return proto.CompactTextString(m) }
...
func (m *SuccinctSpecialTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SuccinctSpecialTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SuccinctSpecialTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SuccinctSpecialTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SuccinctSpecialTx.Merge(m, src)
}
func (m *SuccinctSpecialTx) XXX_Size() int {
	return m.Size()
}
func (m *SuccinctSpecialTx) XXX_DiscardUnknown() {
	xxx_messageInfo_SuccinctSpecialTx.DiscardUnknown(m)
}

var xxx_messageInfo_SuccinctSpecialTx proto.InternalMessageInfo

func (m *SuccinctSpecialTx) GetApprovedTxHash() [][]byte {
	if m != nil {
		return m.ApprovedTxHash
	}
	return nil
}

func (m *SuccinctSpecialTx) GetMilestoneProposition() *types.MilestoneProposition {
	if m != nil {
		return m.MilestoneProposition
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SuccinctSpecialTx)(nil), "heimdallv2.sidetxs.SuccinctSpecialTx")
}
...
var fileDescriptor_75911ad509cf3b3b = []byte{
	...
	,
}
...
func (m *SuccinctSpecialTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SuccinctSpecialTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SuccinctSpecialTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ApprovedTxHash) > 0 {
		for iNdEx := len(m.ApprovedTxHash) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ApprovedTxHash[iNdEx])
			copy(dAtA[i:], m.ApprovedTxHash[iNdEx])
			i = encodeVarintVoteExt(dAtA, i, uint64(len(m.ApprovedTxHash[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *SuccinctSpecialTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.ApprovedTxHash) > 0 {
		for _, b := range m.ApprovedTxHash {
			l = len(b)
			n += 1 + l + sovVoteExt(uint64(l))
		}
	}
...
func (m *SuccinctSpecialTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SuccinctSpecialTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SuccinctSpecialTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApprovedTxHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ApprovedTxHash = append(m.ApprovedTxHash, make([]byte, postIndex-iNdEx))
			copy(m.ApprovedTxHash[len(m.ApprovedTxHash)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MilestoneProposition", wireType)
