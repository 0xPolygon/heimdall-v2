...
// 		NewJoinValidatorCmd(valAddrCodec),
...
// 		JoinValidatorCmd(valAddrCodec),
// 		StakeUpdateCmd(valAddrCodec),
// 		SignerUpdateCmd(valAddrCodec),
// 		ValidatorExitCmd(valAddrCodec),
// 	)
...
// func JoinValidatorCmd(ac address.Codec) *cobra.Command {
// 	cmd := &cobra.Command{
// 		Use:   "validator-join",
...
// 			proposer, _ := cmd.Flags().GetString(FlagProposerAddress)
// 			txhash, _ := cmd.Flags().GetString(FlagTxHash)
// 			pubkeyStr, _ := cmd.Flags().GetString(FlagWebsite)
// 			amount, _ := cmd.Flags().GetInt64(FlagAmount)
...
// 			msg := types.NewMsgValidatorJoin(valAddr, description, newRate, newMinSelfDelegation)
...
// func NewJoinValidatorCmd(ac address.Codec) *cobra.Command {
// 	cmd := &cobra.Command{
// 		Use:   "validator-join",
// 		Short: "Join Heimdall as a validator",
