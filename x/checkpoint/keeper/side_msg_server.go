...
func (srv *sideMsgServer) SideHandleMsgCheckpoint(ctx sdk.Context, sdkMsg sdk.Msg) (result sidetxs.Vote) {
	...
	if !ok {
		...
		logger.Info("EthCC - Checkpoint - side_msg_server: failed, voting NO", "height", ctx.BlockHeight())
	...
	if err != nil {
		...
		logger.Info("EthCC - Checkpoint - side_msg_server: SUCCESS, voting YES", "height", ctx.BlockHeight())
...
func (srv *sideMsgServer) SideHandleMsgCheckpointAck(ctx sdk.Context, sdkMsg sdk.Msg) sidetxs.Vote {
	...
	if !ok {
		...
		logger.Info("EthCC - Checkpoint ACK - side_msg_server - sideHandler: failed, voting NO", "height", ctx.BlockHeight())
		return sidetxs.Vote_VOTE_NO
	}
	...
	logger.Info("EthCC - Checkpoint ACK - side_msg_server - sideHandler: SUCCESS, voting YES", "height", ctx.BlockHeight())
	return sidetxs.Vote_VOTE_YES
}
...
func (srv *sideMsgServer) PostHandleMsgCheckpoint(ctx sdk.Context, sdkMsg sdk.Msg, sideTxResult sidetxs.Vote) error {
	...
	if !ok {
		...
		logger.Info("EthCC - Checkpoint - side_msg_server - postHandler: failed, not submitting", "height", ctx.BlockHeight())
		return err
	}
	...
	logger.Info("EthCC - Checkpoint - side_msg_server - postHandler: SUCCESS, submitting", "height", ctx.BlockHeight())
...
func (srv *sideMsgServer) PostHandleMsgCheckpointAck(ctx sdk.Context, sdkMsg sdk.Msg, sideTxResult sidetxs.Vote) error {
	...
	if !ok {
		...
		logger.Error(err.Error())
		logger.Info("EthCC - Checkpoint ACK - side_msg_server - postHandler: failed, not updating state and flushing buffer", "height", ctx.BlockHeight())
		return err
	}
	...
	logger.Info("EthCC - Checkpoint ACK - side_msg_server - postHandler: SUCCESS, updating the state and flushing the buffer", "height", ctx.BlockHeight())
