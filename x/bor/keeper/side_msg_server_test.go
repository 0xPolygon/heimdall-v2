...
func (s *KeeperTestSuite) TestSideHandleMsgSpan() {
	...
	testcases := []struct {
		...
		},
		{
			...
			expVote: sidetxs.Vote_VOTE_NO,
			mockFn: func() {
				contractCaller.On("GetBorBlock", (*big.Int)(nil)).Return(&ethTypes.Header{Number: big.NewInt(0)}, nil).Times(1)
			},
		},
		{
			...
			expVote: sidetxs.Vote_VOTE_NO,
			mockFn: func() {
				contractCaller.On("GetBorBlock", (*big.Int)(nil)).Return(&ethTypes.Header{Number: big.NewInt(103)}, nil).Times(1)
			},
		},
		{
			...
			mockFn: func() {
				contractCaller.On("GetBorBlock", (*big.Int)(nil)).Return(&ethTypes.Header{Number: big.NewInt(50)}, nil).Times(1)
			},
		},
	}
