...
replace (
	...
	// Pinned to v0.3.7-beta2-polygon for the v0.7.2-beta3 devops validation tag.
	// Carries the BH-compaction drop and the FindSmallestValueWithBrokenKeys
	// bounded-iterator fix that pair with indexer="null" and the 10m prune
	// interval. Replace with the final non-beta tag once cometbft PR #39 lands.
	github.com/cometbft/cometbft => github.com/0xPolygon/cometbft v0.3.7-beta2-polygon
	github.com/cometbft/cometbft-db => github.com/0xPolygon/cometbft-db v0.14.1-polygon
	github.com/cosmos/cosmos-sdk => github.com/0xPolygon/cosmos-sdk v0.2.9-polygon
