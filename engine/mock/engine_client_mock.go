...
func (m *MockExecutionEngineClient) ForkchoiceUpdatedV2(ctx context.Context, state *engine.ForkChoiceState, attrs *engine.PayloadAttributes) (*engine.ForkchoiceUpdatedResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForkchoiceUpdatedV2", ctx, state, attrs)
	ret0, _ := ret[0].(*engine.ForkchoiceUpdatedResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockExecutionEngineClient) GetPayloadV2(ctx context.Context, payloadId string) (*engine.Payload, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPayloadV2", ctx, payloadId)
	ret0, _ := ret[0].(*engine.Payload)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockExecutionEngineClient) NewPayloadV2(ctx context.Context, payload engine.ExecutionPayload) (*engine.NewPayloadResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewPayloadV2", ctx, payload)
	ret0, _ := ret[0].(*engine.NewPayloadResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
