...
type IContractCaller interface {
	...
	GetValidatorInfo(valID uint64, stakingInfoInstance *stakinginfo.Stakinginfo) (validator types.HeimdallValidator, err error)
...
// ApproveTokens implements IContractCaller.
func (ContractCaller) ApproveTokens(*big.Int, common.Address, common.Address, *erc20.Erc20) error {
	panic("unimplemented")
}

// CheckIfBlocksExist implements IContractCaller.
func (ContractCaller) CheckIfBlocksExist(end uint64) bool {
	panic("unimplemented")
}

// CurrentAccountStateRoot implements IContractCaller.
func (ContractCaller) CurrentAccountStateRoot(stakingInfoInstance *stakinginfo.Stakinginfo) ([32]byte, error) {
	panic("unimplemented")
}

// CurrentHeaderBlock implements IContractCaller.
func (ContractCaller) CurrentHeaderBlock(rootChainInstance *rootchain.Rootchain, childBlockInterval uint64) (uint64, error) {
	panic("unimplemented")
}

// CurrentSpanNumber implements IContractCaller.
func (ContractCaller) CurrentSpanNumber(validatorSet *validatorset.Validatorset) (Number *big.Int) {
	panic("unimplemented")
}

// CurrentStateCounter implements IContractCaller.
func (ContractCaller) CurrentStateCounter(stateSenderInstance *statesender.Statesender) (Number *big.Int) {
	panic("unimplemented")
}

// DecodeNewHeaderBlockEvent implements IContractCaller.
func (ContractCaller) DecodeNewHeaderBlockEvent(common.Address, *ethTypes.Receipt, uint64) (*rootchain.RootchainNewHeaderBlock, error) {
	panic("unimplemented")
}

// DecodeSignerUpdateEvent implements IContractCaller.
func (ContractCaller) DecodeSignerUpdateEvent(common.Address, *ethTypes.Receipt, uint64) (*stakinginfo.StakinginfoSignerChange, error) {
	panic("unimplemented")
}

// DecodeSlashedEvent implements IContractCaller.
func (ContractCaller) DecodeSlashedEvent(common.Address, *ethTypes.Receipt, uint64) (*stakinginfo.StakinginfoSlashed, error) {
	panic("unimplemented")
}

// DecodeStateSyncedEvent implements IContractCaller.
func (ContractCaller) DecodeStateSyncedEvent(common.Address, *ethTypes.Receipt, uint64) (*statesender.StatesenderStateSynced, error) {
	panic("unimplemented")
}

// DecodeUnJailedEvent implements IContractCaller.
func (ContractCaller) DecodeUnJailedEvent(common.Address, *ethTypes.Receipt, uint64) (*stakinginfo.StakinginfoUnJailed, error) {
	panic("unimplemented")
}

// DecodeValidatorExitEvent implements IContractCaller.
func (ContractCaller) DecodeValidatorExitEvent(common.Address, *ethTypes.Receipt, uint64) (*stakinginfo.StakinginfoUnstakeInit, error) {
	panic("unimplemented")
}

// DecodeValidatorJoinEvent implements IContractCaller.
func (ContractCaller) DecodeValidatorJoinEvent(common.Address, *ethTypes.Receipt, uint64) (*stakinginfo.StakinginfoStaked, error) {
	panic("unimplemented")
}

// DecodeValidatorStakeUpdateEvent implements IContractCaller.
func (ContractCaller) DecodeValidatorStakeUpdateEvent(common.Address, *ethTypes.Receipt, uint64) (*stakinginfo.StakinginfoStakeUpdate, error) {
	panic("unimplemented")
}

// DecodeValidatorTopupFeesEvent implements IContractCaller.
func (ContractCaller) DecodeValidatorTopupFeesEvent(common.Address, *ethTypes.Receipt, uint64) (*stakinginfo.StakinginfoTopUpFee, error) {
	panic("unimplemented")
}

// GetBalance implements IContractCaller.
func (ContractCaller) GetBalance(address common.Address) (*big.Int, error) {
	panic("unimplemented")
}

// GetBlockNumberFromTxHash implements IContractCaller.
func (ContractCaller) GetBlockNumberFromTxHash(common.Hash) (*big.Int, error) {
	panic("unimplemented")
}

// GetCheckpointSign implements IContractCaller.
func (ContractCaller) GetCheckpointSign(txHash common.Hash) ([]byte, []byte, []byte, error) {
	panic("unimplemented")
}

// GetConfirmedTxReceipt implements IContractCaller.
func (ContractCaller) GetConfirmedTxReceipt(common.Hash, uint64) (*ethTypes.Receipt, error) {
	panic("unimplemented")
}

// GetHeaderInfo implements IContractCaller.
func (ContractCaller) GetHeaderInfo(headerID uint64, rootChainInstance *rootchain.Rootchain, childBlockInterval uint64) (root common.Hash, start uint64, end uint64, createdAt uint64, proposer string, err error) {
	panic("unimplemented")
}

// GetLastChildBlock implements IContractCaller.
func (ContractCaller) GetLastChildBlock(rootChainInstance *rootchain.Rootchain) (uint64, error) {
	panic("unimplemented")
}

// GetMainChainBlock implements IContractCaller.
func (ContractCaller) GetMainChainBlock(*big.Int) (*ethTypes.Header, error) {
	panic("unimplemented")
}

// GetMainTxReceipt implements IContractCaller.
func (ContractCaller) GetMainTxReceipt(common.Hash) (*ethTypes.Receipt, error) {
	panic("unimplemented")
}

// GetMaticChainBlock implements IContractCaller.
func (ContractCaller) GetMaticChainBlock(*big.Int) (*ethTypes.Header, error) {
	panic("unimplemented")
}

// GetMaticTokenInstance implements IContractCaller.
func (ContractCaller) GetMaticTokenInstance(maticTokenAddress common.Address) (*erc20.Erc20, error) {
	panic("unimplemented")
}

// GetMaticTxReceipt implements IContractCaller.
func (ContractCaller) GetMaticTxReceipt(common.Hash) (*ethTypes.Receipt, error) {
	panic("unimplemented")
}

// GetRootChainInstance implements IContractCaller.
func (ContractCaller) GetRootChainInstance(rootChainAddress common.Address) (*rootchain.Rootchain, error) {
	panic("unimplemented")
}

// GetRootHash implements IContractCaller.
func (ContractCaller) GetRootHash(start uint64, end uint64, checkpointLength uint64) ([]byte, error) {
	panic("unimplemented")
}

// GetSlashManagerInstance implements IContractCaller.
func (ContractCaller) GetSlashManagerInstance(slashManagerAddress common.Address) (*slashmanager.Slashmanager, error) {
	panic("unimplemented")
}

// GetSpanDetails implements IContractCaller.
func (ContractCaller) GetSpanDetails(id *big.Int, validatorSet *validatorset.Validatorset) (*big.Int, *big.Int, *big.Int, error) {
	panic("unimplemented")
}

// GetStakeManagerInstance implements IContractCaller.
func (ContractCaller) GetStakeManagerInstance(stakingManagerAddress common.Address) (*stakemanager.Stakemanager, error) {
	panic("unimplemented")
}

// GetStakingInfoInstance implements IContractCaller.
func (ContractCaller) GetStakingInfoInstance(stakingInfoAddress common.Address) (*stakinginfo.Stakinginfo, error) {
	panic("unimplemented")
}

// GetStateReceiverInstance implements IContractCaller.
func (ContractCaller) GetStateReceiverInstance(stateReceiverAddress common.Address) (*statereceiver.Statereceiver, error) {
	panic("unimplemented")
}

// GetStateSenderInstance implements IContractCaller.
func (ContractCaller) GetStateSenderInstance(stateSenderAddress common.Address) (*statesender.Statesender, error) {
	panic("unimplemented")
}

// GetValidatorInfo implements IContractCaller.
func (ContractCaller) GetValidatorInfo(valID uint64, stakingInfoInstance *stakinginfo.Stakinginfo) (validator types.HeimdallValidator, err error) {
	panic("unimplemented")
}

// GetValidatorSetInstance implements IContractCaller.
func (ContractCaller) GetValidatorSetInstance(validatorSetAddress common.Address) (*validatorset.Validatorset, error) {
	panic("unimplemented")
}

// GetVoteOnHash implements IContractCaller.
func (ContractCaller) GetVoteOnHash(start uint64, end uint64, milestoneLength uint64, hash string, milestoneID string) (bool, error) {
	panic("unimplemented")
}

// IsTxConfirmed implements IContractCaller.
func (ContractCaller) IsTxConfirmed(common.Hash, uint64) bool {
	panic("unimplemented")
}

// SendCheckpoint implements IContractCaller.
func (ContractCaller) SendCheckpoint(signedData []byte, sigs [][3]*big.Int, rootChainAddress common.Address, rootChainInstance *rootchain.Rootchain) (err error) {
	panic("unimplemented")
}

// SendTick implements IContractCaller.
func (ContractCaller) SendTick(signedData []byte, sigs []byte, slashManagerAddress common.Address, slashManagerInstance *slashmanager.Slashmanager) (err error) {
	panic("unimplemented")
}

// StakeFor implements IContractCaller.
func (ContractCaller) StakeFor(common.Address, *big.Int, *big.Int, bool, common.Address, *stakemanager.Stakemanager) error {
	panic("unimplemented")
}
