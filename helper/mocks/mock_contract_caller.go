...
// GetBorBlock provides a mock function with given fields: _a0
func (_m *IContractCaller) GetBorBlock(_a0 *big.Int) (*types.Header, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for GetBorBlock")
	}
