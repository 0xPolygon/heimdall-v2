...
// GetBorChainBlockAuthor provides a mock function with given fields: ctx, blockNum
func (_m *IContractCaller) GetBorChainBlockAuthor(ctx context.Context, blockNum *big.Int) (*common.Address, error) {
