...
// GetBorChainBlocksInBatch provides a mock function with given fields: ctx, start, end
func (_m *IContractCaller) GetBorChainBlocksInBatch(ctx context.Context, start int64, end int64) ([]*types.Header, error) {
	ret := _m.Called(ctx, start, end)

	if len(ret) == 0 {
		panic("no return value specified for GetBorChainBlocksInBatch")
	}

	var r0 []*types.Header
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64) ([]*types.Header, error)); ok {
