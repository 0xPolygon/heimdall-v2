...
import (
	...
	xtypes "github.com/0xPolygon/heimdall-v2/x/types"
)
...
func (_m *IContractCaller) GetValidatorInfo(valID uint64, stakingInfoInstance *stakinginfo.Stakinginfo) (xtypes.Validator, error) {
	...
	var r0 xtypes.Validator
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64, *stakinginfo.Stakinginfo) (xtypes.Validator, error)); ok {
		return rf(valID, stakingInfoInstance)
	}
	if rf, ok := ret.Get(0).(func(uint64, *stakinginfo.Stakinginfo) xtypes.Validator); ok {
		r0 = rf(valID, stakingInfoInstance)
	} else {
		r0 = ret.Get(0).(xtypes.Validator)
	}
