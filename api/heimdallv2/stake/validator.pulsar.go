...
func init() {
	file_heimdallv2_stake_validator_proto_init()
	md_Validators = File_heimdallv2_stake_validator_proto.Messages().ByName("Validators")
...
func (x *Validators) slowProtoReflect() protoreflect.Message {
	mi := &file_heimdallv2_stake_validator_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Validators) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "heimdallv2.stake.Validators.validators":
		return len(x.Validators) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: heimdallv2.stake.Validators"))
		}
		panic(fmt.Errorf("message heimdallv2.stake.Validators does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Validators) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message heimdallv2.stake.Validators does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Validators) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in heimdallv2.stake.Validators", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Validators) Descriptor() ([]byte, []int) {
	return file_heimdallv2_stake_validator_proto_rawDescGZIP(), []int{2}
}
...
var file_heimdallv2_stake_validator_proto_rawDesc = []byte{
	...
	0x01, 0x22, 0x5e, 0x0a, 0x0a, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x12,
	...
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x3a, 0x08, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f,
...
var file_heimdallv2_stake_validator_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_heimdallv2_stake_validator_proto_goTypes = []interface{}{
	...
	(*Validators)(nil),   // 2: heimdallv2.stake.Validators
}
var file_heimdallv2_stake_validator_proto_depIdxs = []int32{
	...
	0, // 2: heimdallv2.stake.Validators.validators:type_name -> heimdallv2.stake.Validator
...
func file_heimdallv2_stake_validator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_heimdallv2_stake_validator_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
