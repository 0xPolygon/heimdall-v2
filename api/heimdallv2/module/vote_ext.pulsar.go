...
func init() {
	file_heimdallv2_module_vote_ext_proto_init()
	md_SideTxResponse = File_heimdallv2_module_vote_ext_proto.Messages().ByName("SideTxResponse")
...
func (x *SideTxResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_heimdallv2_module_vote_ext_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SideTxResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "heimdallv2.module.SideTxResponse.tx_hash":
		return len(x.TxHash) != 0
	case "heimdallv2.module.SideTxResponse.result":
		return x.Result != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: heimdallv2.module.SideTxResponse"))
		}
		panic(fmt.Errorf("message heimdallv2.module.SideTxResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SideTxResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message heimdallv2.module.SideTxResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SideTxResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "heimdallv2.module.SideTxResponse.tx_hash":
		panic(fmt.Errorf("field tx_hash of message heimdallv2.module.SideTxResponse is not mutable"))
	case "heimdallv2.module.SideTxResponse.result":
		panic(fmt.Errorf("field result of message heimdallv2.module.SideTxResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: heimdallv2.module.SideTxResponse"))
		}
...
func (x *fastReflection_SideTxResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in heimdallv2.module.SideTxResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (Vote) Descriptor() protoreflect.EnumDescriptor {
	return file_heimdallv2_module_vote_ext_proto_enumTypes[0].Descriptor()
}

func (Vote) Type() protoreflect.EnumType {
	return &file_heimdallv2_module_vote_ext_proto_enumTypes[0]
}
...
func (*SideTxResponse) Descriptor() ([]byte, []int) {
	return file_heimdallv2_module_vote_ext_proto_rawDescGZIP(), []int{1}
}
...
var File_heimdallv2_module_vote_ext_proto protoreflect.FileDescriptor

var file_heimdallv2_module_vote_ext_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2a, 0x30, 0x0a, 0x04, 0x56, 0x6f, 0x74, 0x65,
	0x12, 0x0d, 0x0a, 0x09, 0x56, 0x4f, 0x54, 0x45, 0x5f, 0x53, 0x4b, 0x49, 0x50, 0x10, 0x00, 0x12,
	0x0c, 0x0a, 0x08, 0x56, 0x4f, 0x54, 0x45, 0x5f, 0x59, 0x45, 0x53, 0x10, 0x01, 0x12, 0x0b, 0x0a,
	0x07, 0x56, 0x4f, 0x54, 0x45, 0x5f, 0x4e, 0x4f, 0x10, 0x02, 0x42, 0xc2, 0x01, 0x0a, 0x15, 0x63,
	0x6f, 0x6d, 0x2e, 0x68, 0x65, 0x69, 0x6d, 0x64, 0x61, 0x6c, 0x6c, 0x76, 0x32, 0x2e, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x42, 0x0c, 0x56, 0x6f, 0x74, 0x65, 0x45, 0x78, 0x74, 0x50, 0x72, 0x6f,
	...
	0x61, 0x6c, 0x6c, 0x76, 0x32, 0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0xa2, 0x02, 0x03, 0x48,
	0x4d, 0x58, 0xaa, 0x02, 0x11, 0x48, 0x65, 0x69, 0x6d, 0x64, 0x61, 0x6c, 0x6c, 0x76, 0x32, 0x2e,
	0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0xca, 0x02, 0x11, 0x48, 0x65, 0x69, 0x6d, 0x64, 0x61, 0x6c,
	0x6c, 0x76, 0x32, 0x5c, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0xe2, 0x02, 0x1d, 0x48, 0x65, 0x69,
	0x6d, 0x64, 0x61, 0x6c, 0x6c, 0x76, 0x32, 0x5c, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5c, 0x47,
	0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x12, 0x48, 0x65, 0x69,
	0x6d, 0x64, 0x61, 0x6c, 0x6c, 0x76, 0x32, 0x3a, 0x3a, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_heimdallv2_module_vote_ext_proto_rawDescOnce sync.Once
	file_heimdallv2_module_vote_ext_proto_rawDescData = file_heimdallv2_module_vote_ext_proto_rawDesc
)

func file_heimdallv2_module_vote_ext_proto_rawDescGZIP() []byte {
	file_heimdallv2_module_vote_ext_proto_rawDescOnce.Do(func() {
		file_heimdallv2_module_vote_ext_proto_rawDescData = protoimpl.X.CompressGZIP(file_heimdallv2_module_vote_ext_proto_rawDescData)
	})
	return file_heimdallv2_module_vote_ext_proto_rawDescData
}
...
func init() { file_heimdallv2_module_vote_ext_proto_init() }
func file_heimdallv2_module_vote_ext_proto_init() {
	if File_heimdallv2_module_vote_ext_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		...
		file_heimdallv2_module_vote_ext_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_heimdallv2_module_vote_ext_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_heimdallv2_module_vote_ext_proto_goTypes,
		DependencyIndexes: file_heimdallv2_module_vote_ext_proto_depIdxs,
		EnumInfos:         file_heimdallv2_module_vote_ext_proto_enumTypes,
		MessageInfos:      file_heimdallv2_module_vote_ext_proto_msgTypes,
	}.Build()
	File_heimdallv2_module_vote_ext_proto = out.File
	file_heimdallv2_module_vote_ext_proto_rawDesc = nil
	file_heimdallv2_module_vote_ext_proto_goTypes = nil
	file_heimdallv2_module_vote_ext_proto_depIdxs = nil
}
