...
type SideTxResponse struct {
	...
	Result Vote   `protobuf:"varint,2,opt,name=result,proto3,enum=heimdallv2.module.Vote" json:"result,omitempty"` // will have YES/NO/UNSPECIFIED depending on the side-tx data
}
...
var file_heimdallv2_module_vote_ext_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x68, 0x65, 0x69,
