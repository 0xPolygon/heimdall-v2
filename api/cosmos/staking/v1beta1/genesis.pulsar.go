...
func (x *_GenesisState_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message GenesisState at list field Validators as it is not of Message kind"))
}
...
func (x *_GenesisState_2_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message GenesisState at list field CurrentValidator_Set as it is not of Message kind"))
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.CurrentValidator_Set) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_2_list{list: &x.CurrentValidator_Set})
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.GenesisState.current_validator_Set":
		return len(x.CurrentValidator_Set) != 0
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.GenesisState.current_validator_Set":
		...
		listValue := &_GenesisState_2_list{list: &x.CurrentValidator_Set}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.staking.v1beta1.GenesisState.staking_sequences":
		if len(x.StakingSequences) == 0 {
...
func (x *fastReflection_GenesisState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.GenesisState.current_validator_Set":
		...
		x.CurrentValidator_Set = *clv.list
	case "cosmos.staking.v1beta1.GenesisState.staking_sequences":
		lv := value.List()
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.GenesisState.current_validator_Set":
		if x.CurrentValidator_Set == nil {
			x.CurrentValidator_Set = []string{}
		}
		value := &_GenesisState_2_list{list: &x.CurrentValidator_Set}
		return protoreflect.ValueOfList(value)
	case "cosmos.staking.v1beta1.GenesisState.staking_sequences":
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.CurrentValidator_Set) > 0 {
			for _, s := range x.CurrentValidator_Set {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.CurrentValidator_Set) > 0 {
			for iNdEx := len(x.CurrentValidator_Set) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.CurrentValidator_Set[iNdEx])
				copy(dAtA[i:], x.CurrentValidator_Set[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.CurrentValidator_Set[iNdEx])))
				i--
				dAtA[i] = 0x12
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CurrentValidator_Set", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.CurrentValidator_Set = append(x.CurrentValidator_Set, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
...
type GenesisState struct {
	...
	CurrentValidator_Set []string `protobuf:"bytes,2,rep,name=current_validator_Set,json=currentValidatorSet,proto3" json:"current_validator_Set,omitempty"`
...
func (x *GenesisState) GetValidators() []string {
	if x != nil {
		return x.Validators
	}
	return nil
...
func (x *GenesisState) GetCurrentValidator_Set() []string {
	if x != nil {
		return x.CurrentValidator_Set
	}
	return nil
}
...
var file_cosmos_staking_v1beta1_genesis_proto_rawDesc = []byte{
	...
	,
...
var file_cosmos_staking_v1beta1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
